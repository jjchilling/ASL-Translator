    ...
    def get_data(self, path, is_vgg, shuffle, augment):
        ...
        if augment:
            ...
            data_gen = tf.keras.preprocessing.image.ImageDataGenerator(
                preprocessing_function=self.preprocess_fn, rotation_range=15, shear_range=0.2, width_shift_range=0.2,
    height_shift_range=0.2, brightness_range=(0.9, 1.1), zoom_range=0.1)
